...
var HomePage = (function () {
    ...
    HomePage.prototype.addMarker = function (latLng) {
    ...
    HomePage.prototype.addInfoWindow = function (marker, content) {
        ...
        google.maps.event.addListener(marker, 'click', function () { infoWindow.open(_this.map, marker); });
    };
    ;
    HomePage.prototype.loadMap = function () {
        ...
        this.geolocation.getCurrentPosition().then(function (position) {
            ...
            google.maps.event.addListener(_this.map, 'click', function (event) { _this.addMarker(event.latLng); });
